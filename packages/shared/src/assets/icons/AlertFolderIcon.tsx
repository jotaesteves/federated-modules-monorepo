export const AlertFolderIcon = () => {
  return (
    <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g clip-path="url(#clip0_5547_28878)">
        <path
          d="M10.0898 10.2324V16.9124"
          stroke="white"
          stroke-width="1.5"
        ...
        />
        <path
          d="M9.13965 18.8223H11.0496"
          stroke="white"
          stroke-width="1.5"
      <g clipPath="url(#clip0_5547_28878)">
        <path
          d="M10.0898 10.2324V16.9124"
          stroke="white"
          strokeWidth="1.5"
