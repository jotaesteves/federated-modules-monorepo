...
export default class InjectGoogleFontsPlugin {
  ...
  apply(compiler: webpack.Compiler) {
    compiler.hooks.compilation.tap('InjectGoogleFontsPlugin', (compilation) => {
      ...
      // Inject link tags into the <head> using HtmlWebpackPlugin's tag pipeline
      hooks.alterAssetTagGroups.tap('InjectGoogleFontsPlugin', (data: any) => {
        const preconnect1 = {
          tagName: 'link',
          voidTag: true,
      ...
      hooks.beforeEmit.tap('InjectGoogleFontsPlugin', (data: any) => {
