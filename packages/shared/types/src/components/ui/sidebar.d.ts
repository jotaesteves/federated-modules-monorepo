...
declare const SidebarTrigger: React.ForwardRefExoticComponent<
  Omit<
    import('@/components/ui/button').ButtonProps & React.RefAttributes<HTMLButtonElement>,
    'ref'
  > &
...
declare const SidebarSeparator: React.ForwardRefExoticComponent<
  Omit<
    Omit<
      import('@radix-ui/react-separator').SeparatorProps & React.RefAttributes<HTMLDivElement>,
      'ref'
    > &
      React.RefAttributes<HTMLDivElement>,
    'ref'
