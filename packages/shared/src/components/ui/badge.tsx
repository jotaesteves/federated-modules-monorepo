...
const badgeVariants = cva(
  'inline-flex items-center rounded-xl border px-2.5 text-[10px] font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',
  {
    variants: {
      variant: {
        default:
